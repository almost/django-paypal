...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Delete the old version of for_auction (which could not have been used, wrong type)
        db.delete_column('paypal_ipn', 'for_auction')

        # Create it again with the correct type
        db.add_column('paypal_ipn', 'for_auction', self.gf('django.db.models.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        # Changing field 'PayPalIPN.for_auction'
        db.delete_column('paypal_ipn', 'for_auction')
        db.add_column('paypal_ipn', 'for_auction', self.gf('models.DecimalField')(null=True, max_digits=64, decimal_places=2))
    ...
    models = {
        'ipn.paypalipn': {
            ...
            'for_auction': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
